...
describe LockJar::Dsl do
  context "Instance" do
    it "load a Jarfile" do
      ...
      jarfile.notations.should eql( {"compile"=>["org.apache.mina:mina-core:2.0.4", "spec/pom.xml"], "runtime"=>["org.apache.tomcat:servlet-api:jar:6.0.35"], "test"=>["junit:junit:jar:4.10"]}  )
