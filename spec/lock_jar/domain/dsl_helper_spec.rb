...
describe LockJar::Domain::DslHelper do
    ...
    it "should merge dsl" do
      ...
      dsl.artifacts.should == {
        "default" => [LockJar::Domain::Jar.new("org.apache.mina:mina-core:2.0.4"), LockJar::Domain::Pom.new("spec/pom.xml"), LockJar::Domain::Jar.new("compile-jar")], 
