    ...
    context "load" do
      ...
      it "should replace dependencies with maps" do
        dsl = LockJar::Dsl.evaluate do
          map 'org.modeshape:modeshape-common', 'tmp'
        ...
        lockfile.should eql( {
          "maps"=>{"org.modeshape:modeshape-common"=>["tmp"]}, 
          "scopes"=>{
            "compile"=>{
              "dependencies"=>["org.modeshape:modeshape-common:2.3.0.Final"], 
              "resolved_dependencies"=>["org.modeshape:modeshape-common:jar:2.3.0.Final", "org.slf4j:slf4j-api:jar:1.5.11", "tmp"]}}})      
      end
    end
